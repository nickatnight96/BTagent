...
# Real AWS key ids carry an AKIA/ASIA prefix; the fixtures deliberately use a
# non-matching FAKEKEY prefix so secret scanners (gitleaks) don't flag them.
STOLEN_ACCESS_KEY_ID = "FAKEKEYEXAMPLESTOLEN"
...
CLOUDTRAIL_FIXTURE_EVENTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "userIdentity": {
            ...
            "accessKeyId": "FAKEKEYEXAMPLEOPSADM",
        },
        "requestParameters": {},
        "errorCode": None,
    },
