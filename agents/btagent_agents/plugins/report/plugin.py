"""Report plugin — professional IR report generation from investigation data."""
...
class ReportPlugin(DefensivePlugin):
    """Incident response report generation plugin.

    Provides tools for generating polished IR reports from investigation data
    using structured templates, per-section generation, and template
    management.
    """
    ...
    def get_tools(self) -> list[Any]:
        """Return LangChain tool instances for report operations."""
        return [generate_report, generate_section, list_templates]

    def get_system_prompt(self) -> str:
        """Return the report agent system prompt.
